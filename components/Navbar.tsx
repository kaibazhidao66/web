      ...
      <div className="mx-auto flex w-full items-center justify-between space-x-4 px-4 py-1">
        <Link href="/" passHref>
          <a className="flex items-center space-x-2 py-2 hover:opacity-80 dark:text-white md:p-2">
            ...
            <span className="hidden font-bold sm:block mobile-title">{siteConfig.title}</span>
          </a>
        </Link>
        ...
        <div className="flex flex-1 items-center space-x-4 text-gray-700 md:flex-initial">
          {siteConfig.links.length !== 0 &&
            siteConfig.links.map((l: { name: string; link: string }) => (
              <a
                ...
                className="flex items-center space-x-2 hover:opacity-80 dark:text-white menu-text"
              >
          ...
          {siteConfig.email && (
            <a href={siteConfig.email} className="flex items-center space-x-2 hover:opacity-80 dark:text-white menu-text">
          ...
          {tokenPresent && (
            <button
              className="flex items-center space-x-2 p-2 hover:opacity-80 dark:text-white menu-text"
          ...
          >
            ...
            <div className="hidden items-center space-x-1 md:flex mobile-serach">
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle transition-all dark:bg-gray-900">
                ...
                <div className="mt-4 max-h-32 overflow-y-scroll font-mono text-sm dark:text-gray-100 jiami">
